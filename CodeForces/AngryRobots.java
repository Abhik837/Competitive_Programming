...
public class AngryRobots
{
    ...
    public static void main(String[] args) {
        double initialV = Double.parseDouble(sc.next());
        double angle = Double.parseDouble(sc.next());
        double initialX = Double.parseDouble(sc.next());
        double initialY = Double.parseDouble(sc.next());
        double time = Double.parseDouble(sc.next());
        double VX = initialV * Math.cos(Math.toRadians(angle));
        double VY = initialV * Math.sin(Math.toRadians(angle));
        
        double finalX = initialX + (VX * time);
        double finalY = initialY + (VY * time) + ((-9.80665 * (Math.pow(time, 2)) * 0.5));
