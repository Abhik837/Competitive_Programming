...
public class ProblemLSecretBits
{
    ...
    public static void main(String[] args) 
    {
        ...
        {
            if(bits.substring(i, i+2 ).equals("00"))
            {
                bits = bits.substring(0, i) + "11" + bits.substring(i+2);
            }
            if(bits.substring(i, i+2 ).equals("01"))
            {
                bits = bits.substring(0, i) + "10" + bits.substring(i+2);
            }
        }
