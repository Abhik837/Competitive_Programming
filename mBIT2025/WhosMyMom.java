...
public class WhosMyMom 
{
    ...
    public static void main(String[] args) {
        ...
        if(person.equals("Hephaestus") || person.equals("Ares"))
        {
            System.out.println("Hera");
        }
        else if(person.equals("Zeus") || person.equals("Hades") || person.equals("Poseidon") || person.equals("Hera") || person.equals("Hestia") || person.equals("Demeter"))
        {
            System.out.println("Rhea");
        }
        else if(person.equals("Apollo") || person.equals("Artemis"))
        {
